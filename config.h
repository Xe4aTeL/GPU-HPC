...
#define GRID_X(SIZE_N) ((int) ceil((SIZE_N + BLOCK_X - 1) / BLOCK_X))
#define GRID_Y(SIZE_N) ((int) ceil((SIZE_N + BLOCK_Y - 1) / BLOCK_Y))           // shouldn't exceed 65535 for CUDA compute capability 5.x and above
